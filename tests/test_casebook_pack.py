"""Regression checks for the orbit-sec-signature-field casebook."""
...
from casebook.harness import assert_expected, orbit_sec_signature_field_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(orbit_sec_signature_field_summary(), assert_expected())
